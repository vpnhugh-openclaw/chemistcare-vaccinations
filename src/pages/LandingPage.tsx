...
import {
  ...
  BookOpen, Clock, CheckCircle2, Shield, Users, BadgeCheck
} from "lucide-react";
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 py-20 md:py-32">
          <div className="max-w-4xl">
            ...
            <motion.h1 initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7, delay: 0.1 }}
              ...
              <span className="text-[#2dd4bf]">ChemistCare</span> Your partner for full scope pharmacy prescribing
            </motion.h1>
            ...
            <motion.p initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7, delay: 0.2 }}
              ...
              Protocol-driven prescribing, automated documentation, and practice-ready workflows — so you prescribe <strong className="text-white">confidently</strong>, not just compliantly.
            </motion.p>
